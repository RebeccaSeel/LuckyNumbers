...
namespace LuckyNumbers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("Your Lucky Numbers must be between these to two numbers for you to win. \n");
            ...
            //for (int i = 0; i < startNum || i > endNum; i++)
            //{
            //    Console.WriteLine("I'm sorry, entry not valid. Please provide a valid whole number: ");
            //}
            ...
            ////DONE (placed at beginning of code) = and let the user know what the jackpot amount is at some point you decide in the program.
            ////DONE = The program should count the number of correctly guessed numbers and output to the console to notify the user. 
            ////DONEExample: You guessed 3 numbers correctly!
            ////DONE = The program should calculate the user's winnings based on the number of numbers guessed correctly.
            ////DONE = The user's winnings should be output to the console.
            ////DONE = Example: You won $256,877.23!
            
            

            

            //int jackpot = 3000000; //this calculates the winngs by jackpot/luckyNumMatches 
            //int totalMatches = 0; //this will be the number of guesses that match the random numbers
            ...
            //for ( int i = 0; i < userNums.Length; i++)
            //{
            //    if (matches.Contains(userNums[i]))
            //    {
            //        totalMatches++
            //    }
            //}
